...
export default function Page() {
    return (
        <>
            <div className="container mx-auto pb-0 h-1/2-screen flex flex-col pt-20 items-center">
                <div
                    className="flex flex-col  bg-back rounded p-10 justify-center items-center text-center gap-8 mb-20 mt-20">
                    <h1 className="text-5xl md:text-6xl font-extrabold text-white">
                        Impressum
                    </h1>
                    <p>Mathis Kr&auml;kel<br/>
                        Hamsterweg, 22b<br/>
            ...
            <div className="container w-8/12 mx-auto pb-0 h-screen flex flex-col pt-20 items-center">
                <div
                    className="flex flex-col  bg-back rounded p-10 text-left gap-8 mb-20 mt-20">
                    <h1 className="text-5xl md:text-6xl font-extrabold text-white">Datenschutz&shy;erkl&auml;rung
                </h1>
                ...
                <h3>Allgemeine Hinweise</h3> <p>Die folgenden Hinweise geben einen einfachen &Uuml;berblick
                    ...
                    Verantwortlichen Stelle&ldquo; in dieser Datenschutzerkl&auml;rung entnehmen.</p> <h4>Wie erfassen
                    ...
                    <p>Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere
                        ...
                        sobald Sie diese Website betreten.</p> <h4>Wof&uuml;r nutzen wir Ihre Daten?</h4> <p>Ein Teil
                    ...
                    Vertr&auml;ge geschlossen oder angebahnt werden k&ouml;nnen, werden die &uuml;bermittelten Daten
                    auch f&uuml;r Vertragsangebote, Bestellungen oder sonstige Auftragsanfragen verarbeitet.</p>
                    <h4>Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4> <p>Sie haben jederzeit das Recht,
                    unentgeltlich Auskunft &uuml;ber Herkunft, Empf&auml;nger und Zweck Ihrer gespeicherten
                    personenbezogenen Daten zu erhalten. Sie haben au&szlig;erdem ein Recht, die Berichtigung oder
                    ...
                    zust&auml;ndigen Aufsichtsbeh&ouml;rde zu.</p> <p>Hierzu sowie zu weiteren Fragen zum Thema
                    Datenschutz k&ouml;nnen Sie sich jederzeit an uns wenden.</p>
                    <h2>2. Hosting</h2>
                    <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                    <h3>Externes Hosting</h3> <p>Diese Website wird extern gehostet. Die personenbezogenen Daten, die
                    ...
                    a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den
                    Zugriff auf Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne
                    des TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar.</p> <p>Unser(e) Hoster wird bzw.
                    werden Ihre Daten nur insoweit verarbeiten, wie dies zur Erf&uuml;llung seiner Leistungspflichten
                    erforderlich ist und unsere Weisungen in Bezug auf diese Daten befolgen.</p> <p>Wir setzen
                    folgende(n) Hoster ein:</p>
                    <p>Netlify</p>
                    <h2>3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
                    <h3>Datenschutz</h3> <p>Die Betreiber dieser Seiten nehmen den Schutz Ihrer pers&ouml;nlichen Daten
                    sehr ernst. Wir behandeln Ihre personenbezogenen Daten vertraulich und entsprechend den gesetzlichen
                    ...
                    Datenverarbeitung auf dieser Website ist:</p> <p>Mathis Kr&auml;kel<br/>
                    Hamsterweg 22b<br/>
                    65307 Bad Schwalbach</p>

                    <p>Telefon: 017644413984<br/>
                    ...
                    <p>Sofern Sie in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen
                        ...
                        Datenverarbeitung zus&auml;tzlich auf Grundlage von &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist
                    ...
                    BETREFFENDER PERSONENBEZOGENER DATEN ZUM ZWECKE DERARTIGER WERBUNG EINZULEGEN; DIES GILT AUCH
                    F&Uuml;R DAS PROFILING, SOWEIT ES MIT SOLCHER DIREKTWERBUNG IN VERBINDUNG STEHT. WENN SIE
